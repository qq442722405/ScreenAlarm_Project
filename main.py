...
class MainWindow(QMainWindow):
    ...
    def create_sensitivity_widget(self, row, value=5):
        ...
        spin.setRange(1, 10)
        spin.setValue(value)
        spin.setFixedWidth(50)                     # 适应列宽
        spin.setButtonSymbols(QSpinBox.NoButtons)  # 无箭头
        spin.setAlignment(Qt.AlignCenter)          # 文字居中
    ...
    def _setup_ui(self):
        ...
        self.table.setColumnWidth(10, 60)   # 灵敏度列宽匹配输入框
