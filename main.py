...
class MonitorThread(QThread):
    ...
    def _preprocess_image(self, img_np):
        try:
            ...
            scaled = cv2.resize(img_np, (width * 3, height * 3), interpolation=cv2.INTER_LINEAR)  # 更快
    ...
    def _capture_and_ocr(self, x, y, width, height):
        ...
        try:
            ...
            result = self.reader.readtext(
                ...
                width_ths=0.5,
                height_ths=0.5,
                text_threshold=0.4,   # 稍微降低阈值以捕获更多
                low_text=0.2
            )
